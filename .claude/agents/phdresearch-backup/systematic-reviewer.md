...
hooks:
  ...
  post: |
    ...
    # LEGACY: npx claude-flow memory store --namespace "research/synthesis" --key "systematic-review"
    npx tsx src/god-agent/universal/cli.ts learn "$SYSTEMATIC_REVIEW" -d "research/synthesis" -t "systematic-review" -c "fact"
---
...
# LEGACY: npx claude-flow memory store --namespace "research/synthesis" --key "systematic-review" --value '{...}'
...
EOF
npx tsx src/god-agent/universal/cli.ts learn --file /tmp/systematic-review.json \
...
# LEGACY: npx claude-flow memory store --namespace "research/synthesis" --key "evidence-quality" --value '{...}'
...
EOF
npx tsx src/god-agent/universal/cli.ts learn --file /tmp/evidence-quality.json \
  -d "research/synthesis" \
  -t "evidence-quality" \
  -c "fact"
...
# LEGACY: npx claude-flow memory store --namespace "research/synthesis" --key "quality-filtered-sources" --value '{...}'
...
EOF
npx tsx src/god-agent/universal/cli.ts learn --file /tmp/quality-filtered-sources.json \
  -d "research/synthesis" \
