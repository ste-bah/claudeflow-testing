...
hooks:
  ...
  post: |
    ...
    # LEGACY: npx claude-flow memory store --namespace "research/meta" --key "self-ask-questions"
    npx tsx src/god-agent/universal/cli.ts learn "$SELF_ASK_QUESTIONS" -d "research/meta" -t "self-ask-questions" -c "fact"
---
