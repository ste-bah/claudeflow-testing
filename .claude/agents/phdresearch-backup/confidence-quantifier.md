...
# LEGACY: npx claude-flow@alpha memory retrieve --key "phd/adversarial-review"
npx tsx src/god-agent/universal/cli.ts query -d "phd" -t "adversarial-review" --json
...
# LEGACY: npx claude-flow@alpha memory retrieve --key "phd/conclusion-section"
npx tsx src/god-agent/universal/cli.ts query -d "phd" -t "conclusion-section" --json
```
