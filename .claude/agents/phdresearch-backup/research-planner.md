...
hooks:
  ...
  post: |
    ...
    # LEGACY: npx claude-flow memory store --namespace "research/execution" --key "research-plan"
    npx tsx src/god-agent/universal/cli.ts learn "$RESEARCH_PLAN" -d "research/execution" -t "research-plan" -c "fact"
---
...
# LEGACY: npx claude-flow memory store --namespace "research/execution" --key "research-plan" --value '{...}'
...
EOF
npx tsx src/god-agent/universal/cli.ts learn --file /tmp/research-plan.json \
...
# LEGACY: npx claude-flow memory store --namespace "research/execution" --key "quality-gates" --value '{...}'
...
EOF
npx tsx src/god-agent/universal/cli.ts learn --file /tmp/quality-gates.json \
  -d "research/execution" \
  -t "quality-gates" \
  -c "fact"
...
# For All Agents
# LEGACY: npx claude-flow memory store --namespace "research/execution" --key "task-dependencies" --value '{...}'
...
EOF
npx tsx src/god-agent/universal/cli.ts learn --file /tmp/task-dependencies.json \
  -d "research/execution" \
  -t "task-dependencies" \
  -c "fact"
