...
export { 
// Semantic search
semanticCodeSearch, SEMANTIC_CODE_SEARCH_DEFINITION, } from './tools/semantic-code-search.js';
export { 
// Repository/code indexing
indexRepository, indexCode, INDEX_REPOSITORY_DEFINITION, INDEX_CODE_DEFINITION, } from './tools/index-repository.js';
export { 
// Code similarity
findSimilarCode, FIND_SIMILAR_CODE_DEFINITION, } from './tools/find-similar-code.js';
export { 
// Index statistics
getIndexStats, getQuickStats, GET_INDEX_STATS_DEFINITION, } from './tools/get-index-stats.js';
// =============================================================================
// CLI Entry Point
// =============================================================================
/**
...
const isDirectExecution = () => {
    ...
    return (scriptPath.endsWith('leann-search/index.ts') ||
