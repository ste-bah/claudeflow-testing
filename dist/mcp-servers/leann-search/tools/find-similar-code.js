 ...
 */
function categorizeSimilarity(score) {
    if (score >= 0.99)
        return 'exact';
    if (score >= 0.95)
 ...
 */
function areResultsDuplicates(a, b, threshold) {
 ...
 */
export async function findSimilarCode(input, context) {
    ...
    const searchResults = context.backend.search(codeEmbedding, searchLimit, false);
...
//# sourceMappingURL=find-similar-code.js.map