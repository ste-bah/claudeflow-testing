 ...
 */
import { APA_VALIDATION_LIMITS, APA_RUNNING_HEAD, APA_ABSTRACT, } from '../constants.js';
// =============================================================================
// ERROR & WARNING CODES
// =============================================================================
...
export function mergeValidationResults(...results) {
    const merged = { valid: true, errors: [], warnings: [] };
...
export function validateRunningHead(text) {
...
export function validateHeadingLevel(level) {
    const result = createEmptyResult();
...
// =============================================================================
export const isValidRunningHead = (text) => validateRunningHead(text).valid;
export const isValidAbstract = (text) => validateAbstract(text).valid;
export const isValidTitle = (title) => validateTitle(title).valid;
export const isValidPaper = (paper) => validatePaper(paper).valid;
export const getErrorsOnly = (result) => result.errors;
export const getWarningsOnly = (result) => result.warnings;
