...
export class DynamicAgentGenerator {
     ...
     */
    async generatePhase6Agents(structure, styleCharacteristics, slug) {
        const agents = [];
     ...
     */
    async buildWriterPrompt(chapter, styleCharacteristics, slug, agentExists) {
...
You MUST follow the chapter structure exactly as specified above.`;
     ...
     */
    async buildAbstractPrompt(styleCharacteristics, slug) {
     ...
     */
    isInPhase7(currentIndex, totalChapters) {
     ...
     * [REQ-PIPE-041]
     */
    getTotalAgentCount(totalChapters) {
...
//# sourceMappingURL=dynamic-agent-generator.js.map