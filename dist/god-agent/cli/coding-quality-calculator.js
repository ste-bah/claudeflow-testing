 ...
 */
export const CODING_PHASE_WEIGHTS = {
 ...
 */
export const CODING_AGENT_MIN_LENGTHS = {
 ...
 */
export const CRITICAL_CODING_AGENTS = [
    'task-analyzer',
    'system-designer',
    'sign-off-approver',
    'phase-1-reviewer',
 ...
 */
export const CODING_EXPECTED_OUTPUTS = {
...
export class CodingQualityCalculator {
    ...
    calculateCodeQuality(text, context) {
        ...
        for (const tier of CODE_QUALITY_TIERS) {
            if (codeLines >= tier.minLines)
                lengthScore = tier.score;
            else
                break;
        }
     ...
     */
    calculateStructuralIntegrity(text) {
        let score = 0;
     ...
     */
    calculateTestCoverage(text, context) {
        let score = 0;
 ...
 */
export function calculateCodingQuality(output, context) {
 ...
 */
export function assessCodingQuality(output, context) {
 ...
 */
export function createCodingQualityContext(agentKey, phase) {
    return {
        agentKey,
        phase,
