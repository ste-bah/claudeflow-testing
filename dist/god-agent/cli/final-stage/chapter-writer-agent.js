 ...
 */
export function getAgentForChapter(chapterTitle) {
...
export class ChapterWriterAgent {
     ...
     */
    constructor(styleProfileId, researchDir) {
     ...
     */
    async generateSynthesisPrompt(input) {
...
`;
    ...
    async writeChapter(input) {
        ...
        for (let i = 0; i < chapter.sections.length; i++) {
            ...
            const synthesized = this.synthesizeSection(sectionId, sectionTitle, deduplicatedContent.paragraphs, wordsPerSection, chapter, style);
...
`;
     ...
     */
    synthesizeSection(sectionId, sectionTitle, paragraphs, targetWords, _chapter, style) {
