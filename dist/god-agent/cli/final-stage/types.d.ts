...
export type FinalStageState = 'IDLE' | 'INITIALIZING' | 'SCANNING' | 'SUMMARIZING' | 'MAPPING' | 'WRITING' | 'COMBINING' | 'VALIDATING' | 'COMPLETED' | 'FAILED';
...
export type FinalStageErrorCode = 'NO_RESEARCH_DIR' | 'OUTPUT_EXISTS' | 'SCAN_FAILED' | 'MAPPING_FAILED' | 'NO_SOURCES' | 'STYLE_ERROR' | 'WRITE_ERROR' | 'TOKEN_OVERFLOW' | 'VALIDATION_FAILED' | 'SECURITY_VIOLATION' | 'CONSTITUTION_VIOLATION';
/**
 * Custom error class for Final Stage operations
 * Exit codes per CONSTITUTION Appendix B
 */
export declare class FinalStageError extends Error {
    readonly code: FinalStageErrorCode;
    readonly recoverable: boolean;
    readonly exitCode?: number | undefined;
    constructor(message: string, code: FinalStageErrorCode, recoverable: boolean, exitCode?: number | undefined);
    /**
