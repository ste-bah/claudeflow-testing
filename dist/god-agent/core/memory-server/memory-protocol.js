...
export function parseMessage(data) {
    ...
    try {
        ...
        throw new InvalidRequestError(`Invalid JSON: ${e.message}`, {
...
function validateStoreKnowledgeParams(params) {
...
function validateGetKnowledgeByDomainParams(params) {
    if (typeof params !== 'object' || params === null) {
        throw new ValidationError('params must be an object');
    }
    const p = params;
...
function validateGetKnowledgeByTagsParams(params) {
    if (typeof params !== 'object' || params === null) {
        throw new ValidationError('params must be an object');
    }
    const p = params;
    ...
    if (!p.tags.every((t) => typeof t === 'string')) {
...
function validateDeleteKnowledgeParams(params) {
    if (typeof params !== 'object' || params === null) {
        throw new ValidationError('params must be an object');
    }
    const p = params;
...
function validateProvideFeedbackParams(params) {
    if (typeof params !== 'object' || params === null) {
        throw new ValidationError('params must be an object');
    }
    const p = params;
    ...
    if (!['positive', 'negative', 'neutral'].includes(p.outcome)) {
        throw new ValidationError('outcome must be "positive", "negative", or "neutral"');
    }
}
function validateQueryPatternsParams(params) {
    if (typeof params !== 'object' || params === null) {
        throw new ValidationError('params must be an object');
    }
    const p = params;
    ...
    if (Array.isArray(p.query) && !p.query.every((n) => typeof n === 'number')) {
        throw new ValidationError('query array must contain only numbers');
    }
    if (p.type !== undefined && !['semantic', 'hybrid', 'pattern-match'].includes(p.type)) {
...
//# sourceMappingURL=memory-protocol.js.map