...
export type PipelineEventType = 'pipeline:start' | 'pipeline:complete' | 'pipeline:fail' | 'agent:start' | 'agent:complete' | 'agent:fail' | 'agent:retrieve' | 'agent:store';
/**
...
export declare class AgentExecutionError extends Error {
    ...
    constructor(agentName: string, position: string, message: string);
}
/**
 * Error thrown when memory key validation fails
 */
export declare class MemoryKeyError extends Error {
    readonly key: string;
    readonly operation: 'retrieve' | 'store' | 'validate';
    constructor(key: string, operation: 'retrieve' | 'store' | 'validate', message: string);
}
/**
 * Error thrown when quality gate fails
 */
export declare class QualityGateError extends Error {
    readonly agentName: string;
    readonly qualityGate: string;
    constructor(agentName: string, qualityGate: string, message: string);
}
/**
