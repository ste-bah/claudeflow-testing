...
export class PipelineExecutionError extends PipelineError {
    ...
    context;
    constructor(message, context) {
        super(`[Pipeline ${context.pipelineId}] Step ${context.stepIndex} ` +
...
export class MemoryCoordinationError extends PipelineError {
    name = 'MemoryCoordinationError';
    context;
    constructor(message, context) {
        super(`[Pipeline ${context.pipelineId}] Memory ${context.operation} failed ` +
...
export class QualityGateError extends PipelineError {
    ...
    context;
    constructor(context) {
        super(`[Pipeline ${context.pipelineId}] Quality gate failed at step ` +
...
export class PipelineTimeoutError extends PipelineError {
    ...
    constructor(context) {
        const scopeMsg = context.scope === 'step'
            ...
            : 'Pipeline';
        super(`[Pipeline ${context.pipelineId}] ${scopeMsg} timed out: ` +
...
export class AgentSelectionError extends PipelineError {
    ...
    context;
    constructor(message, context) {
        super(`[Pipeline ${context.pipelineId}] Agent selection failed at step ` +
 ...
 */
export function createMissingFieldError(pipelineName, field) {
    return new PipelineDefinitionError(`Required field '${field}' is missing or empty`, { pipelineName, invalidField: field });
}
/**
 * Create a PipelineDefinitionError for invalid agent configuration
 */
export function createInvalidAgentError(pipelineName, stepIndex, reason) {
    return new PipelineDefinitionError(`Step ${stepIndex}: ${reason}`, { pipelineName, invalidField: `agents[${stepIndex}]`, details: { reason } });
}
/**
 * Wrap an unknown error as a PipelineExecutionError
 */
export function wrapAsPipelineExecutionError(error, context) {
