 ...
 */
export function getPhaseWeights(phase) {
 ...
 */
export function calculateLScore(breakdown, phase) {
    const weights = getPhaseWeights(phase);
    const weightedSum = breakdown.accuracy * weights.accuracy +
 ...
 */
export function createLScoreBreakdown(components, phase) {
    return {
        ...components,
        composite: calculateLScore(components, phase),
    };
}
//# sourceMappingURL=coding-quality-gate-weights.js.map