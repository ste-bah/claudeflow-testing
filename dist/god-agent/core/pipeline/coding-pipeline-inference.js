 ...
 */
export function inferDependencies(agentKey, phaseAgents) {
 ...
 */
export function inferMemoryReads(agentKey, phaseAgents) {
    const agent = phaseAgents.find(a => a.key === agentKey);
    if (!agent) {
        return [];
    }
 ...
 */
export function inferMemoryWrites(agentKey) {
 ...
 */
export function calculateXPReward(agentKey, isCritical) {
    let baseXP = 50;
...
//# sourceMappingURL=coding-pipeline-inference.js.map