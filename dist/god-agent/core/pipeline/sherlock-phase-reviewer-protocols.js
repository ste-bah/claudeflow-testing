 ...
 */
import { AdversarialPersona, } from './sherlock-phase-reviewer-types.js';
// ═══════════════════════════════════════════════════════════════════════════
 ...
 */
export const PHASE_1_UNDERSTANDING_PROTOCOL = {
    phase: 1,
 ...
 */
export const PHASE_2_EXPLORATION_PROTOCOL = {
    phase: 2,
 ...
 */
export const PHASE_3_ARCHITECTURE_PROTOCOL = {
    phase: 3,
 ...
 */
export const PHASE_4_IMPLEMENTATION_PROTOCOL = {
    phase: 4,
 ...
 */
export const PHASE_5_TESTING_PROTOCOL = {
    phase: 5,
    subject: 'Test Suite',
    evidenceSources: [
        'coding/phase5/tests',
 ...
 */
export const PHASE_6_OPTIMIZATION_PROTOCOL = {
    phase: 6,
 ...
 */
export const PHASE_7_DELIVERY_PROTOCOL = {
    phase: 7,
 ...
 */
export const ALL_PHASE_PROTOCOLS = [
 ...
 */
export function getProtocolForPhase(phase) {
 ...
 */
export function getEvidenceSourcesForPhase(phase) {
 ...
 */
export function getAdversarialPersonasForPhase(phase) {
    const protocol = getProtocolForPhase(phase);
...
//# sourceMappingURL=sherlock-phase-reviewer-protocols.js.map