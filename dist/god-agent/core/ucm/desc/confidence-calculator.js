...
export class ConfidenceCalculator {
     ...
     */
    calculate(similarity, successRate, outcomeCount, episodeCreatedAt, category) {
     ...
     */
    calculateDetailed(similarity, successRate, outcomeCount, episodeCreatedAt, category) {
        const ageDays = this.calculateAgeDays(episodeCreatedAt);
        const threshold = THRESHOLDS[category];
     ...
     */
    isHighConfidence(similarity, successRate, outcomeCount, ageDays) {
        return (similarity >= this.config.high.minSimilarity &&
            successRate !== null &&
     ...
     */
    isMediumConfidence(similarity, successRate, outcomeCount, threshold) {
     ...
     */
    calculateMemoized(similarity, successRate, outcomeCount, episodeCreatedAt, category) {
        // Generate cache key
     ...
     */
    calculateBatch(episodes) {
        return episodes.map(e => this.calculateMemoized(e.similarity, e.successRate, e.outcomeCount, e.episodeCreatedAt, e.category));
    }
    /**
 ...
 */
export function createConfidenceCalculator(config) {
