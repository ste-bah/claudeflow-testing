...
export class DaemonServer {
    ...
    constructor(config) {
        ...
        this.descService = new DescService(undefined, undefined, undefined, this.embeddingProxy);
        this.recoveryService = new RecoveryService();
        this.healthService = new HealthService(this.embeddingProxy);
        // Configure health service
        this.healthService.setEmbeddingConfig(this.config.embedding.httpEndpoint, this.config.embedding.model, this.config.embedding.dimension);
        // Register services
     ...
     */
    registerService(namespace, handler) {
