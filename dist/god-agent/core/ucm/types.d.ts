 ...
 */
export declare const TOKEN_RATIOS: Readonly<Record<ContentType, number>>;
/**
...
export interface ISummarizationConfig {
    maxTokens: number;
    citationsBudget: number;
    keyFindingsBudget: number;
    methodologyBudget: number;
    resultsBudget: number;
