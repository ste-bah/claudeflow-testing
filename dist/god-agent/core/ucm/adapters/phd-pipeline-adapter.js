...
export var PhdPhase;
(function (PhdPhase) {
    PhdPhase["PLANNING"] = "planning";
    PhdPhase["RESEARCH"] = "research";
    PhdPhase["WRITING"] = "writing";
    PhdPhase["QA"] = "qa";
})(PhdPhase || (PhdPhase = {}));
/**
 * Adapter for PhD research pipeline workflows
 */
export class PhdPipelineAdapter {
    name = 'phd-pipeline';
    /**
    ...
    detect(context) {
        ...
        return (pipelineName.includes('phd') ||
...
//# sourceMappingURL=phd-pipeline-adapter.js.map