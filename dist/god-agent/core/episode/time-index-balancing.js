 ...
 */
export function borrowFromLeft(parent, childIdx) {
 ...
 */
export function borrowFromRight(parent, childIdx) {
    const child = parent.children[childIdx];
 ...
 */
export function mergeWithLeft(parent, childIdx) {
    const child = parent.children[childIdx];
    const leftSibling = parent.children[childIdx - 1];
    if (child.isLeaf) {
        // Merge leaf nodes
 ...
 */
export function mergeWithRight(parent, childIdx) {
    const child = parent.children[childIdx];
    const rightSibling = parent.children[childIdx + 1];
    if (child.isLeaf) {
        // Merge leaf nodes
 ...
 */
export function rebalanceChild(parent, childIdx, order) {
...
//# sourceMappingURL=time-index-balancing.js.map