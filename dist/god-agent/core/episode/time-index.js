 ...
 */
import { persistIndex, restoreIndex, getStats, findLeafNode as utilFindLeafNode, findKeyIndex as utilFindKeyIndex, } from './time-index-utils.js';
import { rebalanceChild as utilRebalanceChild, } from './time-index-balancing.js';
/**
...
export class TimeIndex {
    root;
    order = 32; // Cache-friendly ~4KB nodes
    height = 0;
    size = 0;
     ...
     */
    insertNonFull(node, timestamp, episodeId) {
     ...
     */
    removeFromNode(node, timestamp, episodeId) {
     ...
     */
    rebalanceChild(parent, childIdx) {
    ...
    getNearest(timestamp, k) {
        ...
        const results = [];
        let currentLeft = leaf;
        let currentRight = leaf;
...
//# sourceMappingURL=time-index.js.map