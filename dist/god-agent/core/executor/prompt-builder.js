 ...
 */
export function buildPrompt(task, language, request) {
    const parts = [
    ...
    parts.push('', '## Requirements', '1. Generate clean, production-ready code', `2. Follow best practices for ${language}`, '3. Include necessary imports', '4. Add documentation for public APIs', '5. Handle edge cases appropriately', '', '## Output Format', 'Return ONLY the code in markdown code blocks.');
    return parts.join('\n');
}
/**
