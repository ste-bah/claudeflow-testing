 ...
 */
export declare function hasHooks(frontmatter: IAgentFrontmatter): frontmatter is IAgentFrontmatter & {
    hooks: IAgentHooks;
};
/**
 * Type guard to check if frontmatter has pre-hook
 */
export declare function hasPreHook(frontmatter: IAgentFrontmatter): frontmatter is IAgentFrontmatter & {
    hooks: {
        pre: string;
    };
};
 ...
 */
export declare function hasPostHook(frontmatter: IAgentFrontmatter): frontmatter is IAgentFrontmatter & {
    hooks: {
        post: string;
    };
};
 ...
 */
export declare const DEFAULT_LOADER_OPTIONS: Required<Omit<IAgentLoaderOptions, 'basePath'>>;
/**
 * Default frontmatter for agents without YAML
 */
export declare function createDefaultFrontmatter(key: string): IAgentFrontmatter;
