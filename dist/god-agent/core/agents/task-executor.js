...
export class TaskExecutor {
     ...
     */
    async execute(agent, task, executeTask, options) {
        ...
        if (this.verbose) {
            console.log(`[TaskExecutor] Executing task with agent: ${agent.key} (${agent.category})`);
        ...
        try {
            ...
            throw new AgentExecutionError(agent.key, agent.category, task, execError, duration);
        }
    }
    /**
