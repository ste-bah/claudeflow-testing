 ...
 */
export declare class TrajectoryValidationError extends Error {
    constructor(message: string);
}
/**
 * Error thrown when weight update fails
 */
export declare class WeightUpdateError extends Error {
    readonly patternId: PatternID;
    constructor(patternId: PatternID, message: string);
}
/**
 * Error thrown when drift exceeds threshold
 */
export declare class DriftExceededError extends Error {
 ...
 */
export declare class WeightPersistenceError extends Error {
    readonly operation: 'save' | 'load';
    constructor(operation: 'save' | 'load', message: string);
}
/**
 ...
 */
export declare class RollbackLoopError extends Error {
    readonly rollbackCount: number;
    readonly timeWindowMs: number;
    constructor(rollbackCount: number, timeWindowMs: number);
}
/**
 * Error thrown when checkpoint operation fails
 */
export declare class CheckpointError extends Error {
    readonly operation: 'create' | 'rollback' | 'load' | 'save';
 ...
 */
export type ReasoningStepAction = 'query_vectordb' | 'query_reasoningbank' | 'causal_inference' | 'pattern_match' | 'embedding_generation' | 'similarity_search' | 'analogical_mapping' | 'temporal_analysis' | 'code_generation' | 'validation' | 'custom';
/**
