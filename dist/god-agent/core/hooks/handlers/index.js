...
getCapturedResult, hasCapturedResult, getCapturedResultCount, getCapturedTrajectoryIds, clearCapturedResult, 
// Testing utilities
_clearCapturedResultsForTesting } from './task-result-capture.js';
// ============================================================================
...
// Callback management
setQualityAssessmentCallback, hasQualityAssessmentCallback, 
// Learning feedback callback (TASK-HOOK-009)
setLearningFeedbackCallback, hasLearningFeedbackCallback, 
// Constants
QUALITY_THRESHOLDS, 
// Testing utilities
_clearQualityAssessmentCallbackForTesting, _clearLearningFeedbackCallbackForTesting } from './quality-assessment-trigger.js';
// ============================================================================
...
setDescServiceGetter, setSonaEngineGetter, 
// Testing utilities
_resetAutoInjectionForTesting } from './auto-injection.js';
// ============================================================================
 ...
 * ```
 */
export function registerRequiredHooks() {
