...
let learningFeedbackCallback = null;
/**
 ...
 */
export function setQualityAssessmentCallback(callback) {
 ...
 * ```
 */
export function setLearningFeedbackCallback(callback) {
 ...
 */
export function hasQualityAssessmentCallback() {
 ...
 * @returns True if callback is registered
 */
export function hasLearningFeedbackCallback() {
 ...
 */
export function _clearQualityAssessmentCallbackForTesting() {
 ...
 * WARNING: Only for testing purposes
 */
export function _clearLearningFeedbackCallbackForTesting() {
 ...
 */
export function registerQualityAssessmentTriggerHook() {
    registerPostToolUseHook({
        ...
        handler: async (context) => {
            try {
                ...
                const assessment = await qualityCallback(context.trajectoryId, context.toolOutput, {
                    toolName: context.toolName,
                ...
                if (learningFeedbackCallback && meetsFeedbackThreshold) {
                    try {
                        await learningFeedbackCallback(context.trajectoryId, assessment.score, {
                            toolName: context.toolName,
                            sessionId: context.sessionId,
                            meetsPatternThreshold,
                            meetsFeedbackThreshold,
...
//# sourceMappingURL=quality-assessment-trigger.js.map