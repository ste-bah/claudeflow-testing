 ...
 */
export type HookHandler<T extends IHookContext = IHookContext> = (context: T) => Promise<IHookResult>;
/**
 ...
 */
export type IHookInput<T extends IHookContext = IHookContext> = Omit<IHook<T>, 'priority' | 'enabled' | 'description'> & IHookRegistrationOptions;
/**
 * Required hooks that MUST be registered before initialization
 * Per CONSTITUTION RULE-032
 */
export declare const REQUIRED_HOOKS: readonly string[];
/**
 * Default hook priorities by category
 */
export declare const DEFAULT_PRIORITIES: {
    /** Validation and safety hooks */
    readonly VALIDATION: 10;
    /** Context injection hooks */
    readonly INJECTION: 20;
...
export declare class HookError extends Error {
    ...
    constructor(code: HookErrorCode, message: string, context?: Record<string, unknown> | undefined);
}
