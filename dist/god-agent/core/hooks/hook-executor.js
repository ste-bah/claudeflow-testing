...
export class HookExecutor {
     ...
     */
    async executePreToolUseHooks(context) {
     ...
     */
    async executePostToolUseHooks(context) {
        const chainStartTime = performance.now();
        // Get hooks from registry (already sorted by priority)
     ...
     */
    async executeHookWithIsolation(hook, context) {
     ...
     */
    async _executeHookDirectlyForTesting(hook, context) {
 ...
 */
export function getHookExecutor() {
    if (!executorInstance) {
 ...
 */
export function _resetHookExecutorForTesting() {
