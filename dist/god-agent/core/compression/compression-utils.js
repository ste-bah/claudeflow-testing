 ...
 */
export function encodeFloat16(vector) {
 ...
 */
export function trainPQCodebook(vectors, numSubvectors, numCentroids, maxIterations = 20) {
    if (vectors.length === 0) {
 ...
 */
function kMeansClustering(vectors, k, maxIterations) {
    const dim = vectors[0].length;
 ...
 */
export function encodePQ8(vector, codebook) {
 ...
 */
export function decodePQ8(codes, codebook, originalDim) {
 ...
 */
export function encodePQ4(vector, codebook) {
 ...
 */
export function decodePQ4(codes, codebook, originalDim) {
    const vector = new Float32Array(originalDim);
    for (let sv = 0; sv < codebook.numSubvectors; sv++) {
        const start = sv * codebook.subvectorDim;
        const end = Math.min(start + codebook.subvectorDim, originalDim);
 ...
 */
export function trainBinaryThresholds(vectors) {
    if (vectors.length === 0) {
 ...
 */
export function encodeBinary(vector, thresholds) {
 ...
 */
export function decodeBinary(encoded, thresholds) {
 ...
 */
export function calculateReconstructionError(original, reconstructed) {
 ...
 */
export function cosineSimilarityCompression(a, b) {
 ...
 */
export function uint8ToUint16(data) {
 ...
 */
export function uint16ToUint8(data) {
