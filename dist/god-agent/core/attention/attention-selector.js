 ...
 * - Confidence scoring
 */
import { DEFAULT_SELECTION_THRESHOLDS, AttentionError, hashDataProfile, } from './attention-types.js';
// ==================== Selector Class ====================
/**
...
export class AttentionSelector {
    ...
    verbose;
    metricsCallback;
    constructor(registry, thresholds = {}, options = {}) {
     ...
     */
    createWithFallback(selection, config) {
        ...
        if (!standardDescriptor) {
            throw new AttentionError('Critical: Standard attention mechanism not registered', 'CREATION_FAILED');
        }
...
//# sourceMappingURL=attention-selector.js.map