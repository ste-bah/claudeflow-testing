 ...
 * ```
 */
export class RealCausalAttention {
    name = 'causal';
    dimension;
    numHeads;
    headDim;
    ...
    forward(query, key, value, mask, seqLen) {
        ...
        for (let h = 0; h < this.numHeads; h++) {
            const headOutput = this.computeHeadCausalAttention(qProjected, kProjected, vProjected, h, actualSeqLen, mask);
     ...
     *   [1 1 1 1]
     */
    computeHeadCausalAttention(Q, K, V, head, seqLen, mask) {
...
//# sourceMappingURL=causal-attention.js.map