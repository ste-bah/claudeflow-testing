 ...
 * ```
 */
export class RealReformerAttention {
    name = 'reformer';
    dimension;
    numHeads;
    headDim;
    ...
    constructor(config) {
        ...
        if (this.numHashBuckets % 2 !== 0) {
            throw new Error(`ANTI-009: numHashBuckets ${this.numHashBuckets} must be even for angular LSH`);
        }
    ...
    forward(query, key, value, mask, seqLen) {
        ...
        for (let h = 0; h < this.numHeads; h++) {
            const headOutput = this.computeHeadLSHAttention(qProjected, kProjected, vProjected, h, actualSeqLen, mask);
     ...
     */
    computeHeadLSHAttention(Q, K, V, head, seqLen, mask) {
...
//# sourceMappingURL=reformer-attention.js.map