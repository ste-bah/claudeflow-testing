 ...
 * ```
 */
export class RealBidirectionalAttention {
    name = 'bidirectional';
    dimension;
    numHeads;
    headDim;
    ...
    forward(query, key, value, mask, seqLen) {
        ...
        for (let h = 0; h < this.numHeads; h++) {
            const headOutput = this.computeHeadBidirectionalAttention(qProjected, kProjected, vProjected, h, actualSeqLen, mask);
     ...
     */
    computeHeadBidirectionalAttention(Q, K, V, head, seqLen, mask) {
...
//# sourceMappingURL=bidirectional-attention.js.map