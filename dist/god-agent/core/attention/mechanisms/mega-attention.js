...
export class RealMegaAttention {
    ...
    forward(query, key, value, mask, seqLen) {
        ...
        const attentionOutput = this.applySingleHeadAttention(emaOutput, emaOutput, emaOutput, mask, seqLen);
     ...
     */
    applySingleHeadAttention(query, key, value, mask, seqLen) {
        // Project Q, K, V
...
//# sourceMappingURL=mega-attention.js.map