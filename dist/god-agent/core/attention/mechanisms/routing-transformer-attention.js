...
export class RealRoutingTransformerAttention {
    ...
    forward(query, key, value, mask, seqLen) {
        ...
        for (let h = 0; h < this.numHeads; h++) {
            ...
            const headOutput = this.computeRoutedAttention(qHead, kHead, vHead, routedClusters, mask);
            // Write to output
     ...
     */
    computeRoutedAttention(qHead, kHead, vHead, routedClusters, mask) {
...
//# sourceMappingURL=routing-transformer-attention.js.map