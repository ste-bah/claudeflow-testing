...
export class RealBlockSparseAttention {
    name = 'block-sparse';
    dimension;
    numHeads;
    headDim;
     ...
     */
    generateRandomBlockConnections(numBlocks) {
     ...
     */
    getAttendBlocks(blockIdx, numBlocks, randomConnections) {
        const attendBlocks = new Set();
        // 1. Self (diagonal)
...
//# sourceMappingURL=block-sparse-attention.js.map