 ...
 * ```
 */
export class RealPerformerAttention {
    name = 'performer';
    dimension;
    numHeads;
    headDim;
    numFeatures; // Number of random features (m)
    scale;
    ...
    forward(query, key, value, mask, seqLen) {
        ...
        for (let h = 0; h < this.numHeads; h++) {
            const headOutput = this.computeHeadFavorAttention(qProjected, kProjected, vProjected, h, actualSeqLen, mask);
     ...
     */
    computeHeadFavorAttention(Q, K, V, head, seqLen, mask) {
...
//# sourceMappingURL=performer-attention.js.map