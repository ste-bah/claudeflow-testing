 ...
 * ```
 */
export class RealLinearAttention {
    name = 'linear';
    dimension;
    numHeads;
    headDim;
    ...
    forward(query, key, value, mask, seqLen) {
        ...
        for (let h = 0; h < this.numHeads; h++) {
            const headOutput = this.computeHeadLinearAttention(qFeature, kFeature, vProjected, h, actualSeqLen, mask);
     ...
     */
    computeHeadLinearAttention(qFeature, kFeature, V, head, seqLen, mask) {
...
//# sourceMappingURL=linear-attention.js.map