 ...
 */
export class RealLunaAttention {
    name = 'luna';
    dimension;
    numHeads;
    headDim;
    ...
    wq; // [dimension, dimension]
    wk; // [dimension, dimension]
    ...
    constructor(config = {}) {
        ...
        this.packProjection = xavierUniform(this.projectedLength, this.dimension, rng);
     ...
     */
    softmaxInPlace(arr, offset, length, mask) {
...
//# sourceMappingURL=luna-attention.js.map