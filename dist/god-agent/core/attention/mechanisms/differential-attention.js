 ...
 * ```
 */
export class RealDifferentialAttention {
    name = 'differential';
    dimension;
    numHeads;
    headDim;
    halfHeadDim;
    scale;
    lambda; // Learnable subtraction coefficient
    ...
    constructor(config) {
        ...
        if (this.headDim % 2 !== 0) {
            throw new Error(`ANTI-009: headDim ${this.headDim} must be even for differential attention Q/K split`);
        }
    ...
    forward(query, key, value, mask, seqLen) {
        ...
        for (let h = 0; h < this.numHeads; h++) {
            const headOutput = this.computeHeadDifferentialAttention(qProjected, kProjected, vProjected, h, actualSeqLen, mask);
     ...
     */
    computeHeadDifferentialAttention(Q, K, V, head, seqLen, mask) {
...
//# sourceMappingURL=differential-attention.js.map