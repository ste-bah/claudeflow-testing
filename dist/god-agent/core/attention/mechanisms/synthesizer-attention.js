 ...
 */
export class RealSynthesizerAttention {
    name = 'synthesizer';
    dimension;
    numHeads;
    maxSeqLen;
     ...
     */
    synthesizeAttention(input, seqLen, headIdx, mask) {
     ...
     */
    projectValues(value, seqLen, headIdx) {
     ...
     */
    applyAttention(attnWeights, V, seqLen) {
     ...
     */
    getParameterCount() {
        const perHead = this.dimension * this.bottleneck + // W1
            this.bottleneck + // b1
...
//# sourceMappingURL=synthesizer-attention.js.map