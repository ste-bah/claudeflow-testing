 ...
 * - Factory functions
 */
import { ComplexityClass, } from './attention-types.js';
...
export class AttentionMechanismRegistry {
    ...
    findByCapability(capability) {
        return Array.from(this.mechanisms.values()).filter(m => m.capabilities[capability]);
    }
    /**
     * Find mechanisms by complexity class
     */
    findByComplexity(complexity) {
        return Array.from(this.mechanisms.values()).filter(m => m.performance.complexity === complexity);
    }
    /**
...
//# sourceMappingURL=attention-registry.js.map