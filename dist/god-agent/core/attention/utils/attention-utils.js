 ...
 * ```
 */
export function softmax2D(scores, seqLen) {
    const result = new Float32Array(scores.length);
    // Validate input
    if (scores.length !== seqLen * seqLen) {
        throw new Error(`Score length ${scores.length} incompatible with seqLen ${seqLen}`);
    }
    // Row-wise softmax
 ...
 */
export function validateSoftmax(weights, seqLen, tolerance = 1e-6) {
 ...
 */
export function hasNaNOrInf(arr) {
...
//# sourceMappingURL=attention-utils.js.map