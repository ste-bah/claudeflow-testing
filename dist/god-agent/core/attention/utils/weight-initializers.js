 ...
 * ```
 */
export function xavierUniform(fanIn, fanOut, rng) {
    if (fanIn <= 0 || fanOut <= 0) {
 ...
 */
export function xavierVariance(fanIn, fanOut) {
 ...
 */
export function validateXavierWeights(weights, fanIn, fanOut, tolerance = 0.1) {
    const size = fanIn * fanOut;
...
//# sourceMappingURL=weight-initializers.js.map