...
export class ClaudeCodeExecutor {
    ...
    async execute(prompt, agent) {
        ...
        try {
            ...
            throw new Error(`Claude Code execution failed for agent "${agentType}" (executionId: ${executionId}, duration: ${executionTimeMs}ms): ${errorMessage}`, { cause: error });
        }
    }
    /**
     ...
     */
    async executeInternal(prompt, agent) {
 ...
 */
export function createClaudeCodeExecutor(config) {
