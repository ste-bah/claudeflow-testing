...
export class ContrastiveLoss {
    ...
    constructor(config = {}) {
        ...
        if (this.config.positiveThreshold <= this.config.negativeThreshold) {
            throw new Error(`Invalid thresholds: positiveThreshold (${this.config.positiveThreshold}) ` +
     ...
     */
    static createPairs(trajectories, queryEmbedding, config = {}) {
     ...
     */
    static createPairsFromRecords(records, queryEmbedding, config = {}) {
 ...
 */
export function mineHardNegatives(query, negatives, topK = 5) {
 ...
 */
export function mineHardPositives(query, positives, topK = 5) {
 ...
 */
export function createSemiHardTriplets(query, positives, negatives, margin = DEFAULT_MARGIN) {
    const pairs = [];
...
//# sourceMappingURL=contrastive-loss.js.map