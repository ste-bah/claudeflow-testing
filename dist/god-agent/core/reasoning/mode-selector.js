...
export class ModeSelector {
     ...
     */
    analyzeForPatternMatch(request) {
        let score = 0.0;
     ...
     * @returns Score 0.0-1.0
     */
    analyzeForCausalInference(request) {
        let score = 0.0;
        const query = request.query.toLowerCase();
        // Check for causal keywords
        const causalKeywordCount = this.causalKeywords.filter(keyword => query.includes(keyword.toLowerCase())).length;
