 ...
 */
import type { IReasoningRequest, IReasoningResponse, ReasoningMode } from './reasoning-types.js';
 ...
 */
export declare enum AdvancedReasoningMode {
 ...
 */
export type AnyAdvancedMode = AdvancedReasoningMode.ANALOGICAL | AdvancedReasoningMode.ABDUCTIVE | AdvancedReasoningMode.COUNTERFACTUAL | AdvancedReasoningMode.DECOMPOSITION | AdvancedReasoningMode.ADVERSARIAL | AdvancedReasoningMode.TEMPORAL | AdvancedReasoningMode.CONSTRAINT_BASED | AdvancedReasoningMode.FIRST_PRINCIPLES;
/**
 * Union type of all advanced reasoning configs
 */
export type AnyAdvancedConfig = AnalogicalConfig | AbductiveConfig | CounterfactualConfig | DecompositionConfig | AdversarialConfig | TemporalConfig | ConstraintConfig | FirstPrinciplesConfig;
/**
 * Union type of all advanced reasoning results
 */
export type AnyAdvancedResult = IAnalogicalResult | IAbductiveResult | ICounterfactualResult | IDecompositionResult | IAdversarialResult | ITemporalResult | IConstraintResult | IFirstPrinciplesResult;
/**
 * Combined mode type (base + advanced)
 */
export type AllReasoningModes = ReasoningMode | AdvancedReasoningMode;
//# sourceMappingURL=advanced-reasoning-types.d.ts.map