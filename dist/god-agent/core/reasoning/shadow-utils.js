 ...
 */
export function isL2Normalized(vector, tolerance = 0.001) {
    let sumSquares = 0;
    for (let i = 0; i < vector.length; i++) {
 ...
 */
export function classifyDocument(hypothesisSimilarity, shadowSimilarity, thresholds = DEFAULT_CLASSIFICATION_THRESHOLDS) {
    ...
    if (hypothesisSimilarity >= medium &&
 ...
 */
export function determineEvidenceType(classification, refutationStrength) {
 ...
 */
export function calculateCredibility(supportStrengths, refutationStrengths) {
 ...
 */
export function determineVerdict(credibility, supportCount, contradictionCount) {
    // No evidence
 ...
 */
export function calculateVerdictConfidence(supportStrengths, refutationStrengths) {
 ...
 */
export function calculateRefutationStrength(hypothesisSimilarity, shadowSimilarity) {
 ...
 */
export function sortByRefutationStrength(results) {
