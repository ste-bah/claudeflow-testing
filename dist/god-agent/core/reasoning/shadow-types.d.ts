 ...
 */
export declare class ShadowVectorError extends Error {
    readonly code: 'INVALID_VECTOR' | 'SEARCH_FAILED' | 'VALIDATION_FAILED' | 'CONFIG_ERROR';
    constructor(message: string, code: 'INVALID_VECTOR' | 'SEARCH_FAILED' | 'VALIDATION_FAILED' | 'CONFIG_ERROR');
}
/**
 ...
 */
export declare const DEFAULT_CLASSIFICATION_THRESHOLDS: IClassificationThresholds;
/**
 * Default shadow vector configuration
 */
export declare const DEFAULT_SHADOW_CONFIG: Required<IShadowVectorConfig>;
