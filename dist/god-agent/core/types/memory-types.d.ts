 ...
 */
export type MemoryMethod = 'storeKnowledge' | 'getKnowledgeByDomain' | 'getKnowledgeByTags' | 'deleteKnowledge' | 'provideFeedback' | 'queryPatterns' | 'getStatus' | 'ping';
/**
 ...
 */
export type MemoryErrorCode = 'INVALID_REQUEST' | 'UNKNOWN_METHOD' | 'VALIDATION_ERROR' | 'STORAGE_ERROR' | 'SERVER_SHUTTING_DOWN' | 'TIMEOUT' | 'MAX_CONNECTIONS' | 'SERVER_NOT_RUNNING' | 'SERVER_DISCONNECTED';
/**
...
export declare const DEFAULT_SOCKET_PATH = "/tmp/god-agent-memory.sock";
/** Default HTTP port for Windows fallback */
export declare const DEFAULT_HTTP_PORT = 47654;
...
export declare const DEFAULT_RECONNECT_DELAY_MS = 1000;
...
export declare const DEFAULT_HEALTH_CHECK_INTERVAL_MS = 10000;
...
export declare const MEMORY_SERVER_VERSION = "1.0.0";
