 ...
 * @since v1.0
 */
export declare const DEFAULT_STREAMING_CONFIG: ITrajectoryStreamConfig;
/**
 ...
 * @since v1.0
 */
export declare enum TrajectoryStreamError {
    /**
 ...
 */
export declare class ERR_MULTI_PROCESS extends Error {
    constructor(message: string);
}
/**
 * Error thrown when rollback loop detected.
 */
export declare class ERR_ROLLBACK_LOOP extends Error {
    constructor(message: string);
}
/**
 * Error thrown when checkpoint is invalid.
 */
export declare class ERR_INVALID_CHECKPOINT extends Error {
    constructor(message: string);
}
/**
 * Error thrown when migration fails.
 */
export declare class ERR_MIGRATION_FAILED extends Error {
    constructor(message: string);
}
/**
 * Error thrown when attempting to delete baseline checkpoint.
 */
export declare class ERR_DELETE_BASELINE extends Error {
    constructor(message: string);
}
/**
 * Error thrown when operation not allowed in read-only mode.
 */
export declare class ERR_READ_ONLY extends Error {
    constructor(message: string);
}
//# sourceMappingURL=trajectory-streaming-types.d.ts.map