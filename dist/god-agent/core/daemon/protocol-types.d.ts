 ...
 */
export declare const RPC_ERROR_MESSAGES: Record<RpcErrorCode, string>;
/**
 * Create a JSON-RPC error object
 */
export declare function createRpcError(code: RpcErrorCode | number, message?: string, data?: unknown): JsonRpcError;
/**
 * Create a JSON-RPC success response
 */
export declare function createSuccessResponse(result: unknown, id: string | number | null): JsonRpcResponse;
/**
 * Create a JSON-RPC error response
 */
export declare function createErrorResponse(error: JsonRpcError, id: string | number | null): JsonRpcResponse;
/**
 * Check if request is a notification (no id field)
 */
export declare function isNotification(request: JsonRpcRequest | JsonRpcNotification): request is JsonRpcNotification;
/**
 * Check if message is a valid JSON-RPC request structure
 */
export declare function isValidRequest(msg: unknown): msg is JsonRpcRequest;
/**
 * Check if message is a batch request
 */
export declare function isBatchRequest(msg: unknown): msg is unknown[];
/**
 * Validate method name format
 * Methods should be lowercase with optional dots for namespacing
 */
export declare function isValidMethodName(method: string): boolean;
/**
 * Extract service name from method (e.g., "search.query" -> "search")
 */
export declare function extractServiceName(method: string): string;
/**
 * Extract method name from full method (e.g., "search.query" -> "query")
 */
export declare function extractMethodName(method: string): string;
