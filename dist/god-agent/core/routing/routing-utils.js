 ...
 */
export function matVecMul(matrix, vector, rows, cols) {
 ...
 */
export function calculateUncertainty(probabilities) {
    if (probabilities.length === 0)
        return 1;
 ...
 */
export function calculateScore(similarity, temperature = 1.0) {
 ...
 */
export function timeUntilExpiry(expiryTimestamp) {
 ...
 */
export function initFromEmbeddings(embeddings, inputDim, hiddenDim) {
