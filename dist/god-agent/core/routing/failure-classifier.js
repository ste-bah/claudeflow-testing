...
export class FailureClassifier {
     ...
     */
    detectUserOverride(feedback) {
        return Boolean(feedback.userOverrideAgent &&
     ...
     */
    detectAgentError(feedback) {
        return Boolean(!feedback.success &&
