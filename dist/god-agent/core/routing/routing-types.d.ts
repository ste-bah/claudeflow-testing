 ...
 */
export type TaskDomain = 'research' | 'testing' | 'code' | 'writing' | 'design' | 'review';
/**
 ...
 */
export type ColdStartPhase = 'keyword-only' | 'blended' | 'learned';
/**
 * Failure type for classification
 * Per RULE-DAI-003-007: Failure attribution before learning
 */
export type FailureType = 'ROUTING_FAILURE' | 'AGENT_FAILURE' | 'TASK_IMPOSSIBLE' | 'PARTIAL_SUCCESS';
/**
 ...
 */
export declare const DEFAULT_COLD_START_CONFIG: IColdStartConfig;
/**
 * Default routing configuration
 */
export declare const DEFAULT_ROUTING_CONFIG: IRoutingConfig;
/**
