...
export class LoopDetector {
     ...
     */
    dfsDetectCycle(nodeId, adjacency, chainId, path) {
     ...
     */
    wouldCreateCycle(from, to, nodes) {
     ...
     */
    canReach(source, target, adjacency, visited) {
        if (source === target) {
            return true;
        }
 ...
 */
export function validateNoCycles(nodes, chainId) {
