...
export class FusionScorer {
    ...
    calculateActiveWeights(aggregated) {
        ...
        if (failedWeight > 0 && activeSources.length > 0) {
            const totalActiveWeight = activeSources.reduce((sum, source) => sum + activeWeights[source], 0);
     ...
     */
    scoreResults(groups, activeWeights) {
        const results = [];
...
//# sourceMappingURL=fusion-scorer.js.map