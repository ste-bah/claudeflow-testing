 ...
 */
export type ActivityEventStatus = 'pending' | 'running' | 'success' | 'error' | 'warning';
/**
 ...
 * Cold start phase
 */
export type ColdStartPhase = 'exploration' | 'learning' | 'exploitation' | 'mature';
/**
...
export declare const BUFFER_LIMITS: {
    ...
    readonly ACTIVITY_STREAM: 1000;
    /** RoutingHistory buffer max size */
    readonly ROUTING_HISTORY: 100;
    /** EventStore buffer max size */
    readonly EVENT_STORE: 10000;
    /** ObservabilityBus queue max size */
    readonly BUS_QUEUE: 100;
};
/**
 * Default daemon configuration
 */
export declare const DEFAULT_DAEMON_CONFIG: IDaemonConfig;
/**
 * Performance budgets per constitution.md
 */
export declare const PERFORMANCE_BUDGETS: {
    /** Max time for event emit */
    readonly EVENT_EMIT_MS: 1;
    /** Max time for socket send */
    readonly SOCKET_SEND_MS: 0.5;
    /** Max time for buffer insert */
    readonly BUFFER_INSERT_MS: 0.1;
    /** Max time for SSE broadcast */
    readonly SSE_BROADCAST_MS: 1;
    /** Max time for SQLite write (async) */
    readonly SQLITE_WRITE_MS: 5;
    /** Max API response time p95 */
    readonly API_RESPONSE_MS: 100;
    /** Max dashboard load time */
    readonly DASHBOARD_LOAD_MS: 1000;
    /** Max daemon startup time */
    readonly DAEMON_STARTUP_MS: 2000;
    /** Max God Agent overhead */
    readonly OVERHEAD_PERCENT: 5;
};
