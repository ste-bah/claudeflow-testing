...
export class SpellingTransformer {
     ...
     */
    static getSpellingRules(variant) {
        if (variant === 'en-US') {
            return [];
        }
...
//# sourceMappingURL=spelling-transformer.js.map