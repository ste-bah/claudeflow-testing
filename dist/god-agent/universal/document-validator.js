...
export class DocumentValidator {
     ...
     */
    defineStructure(title, chapters) {
        this.structure = {
            title,
            chapters,
     ...
     */
    extractChapterReferences(content) {
        const refs = [];
...
export const PHD_DISSERTATION_STRUCTURE = [
