...
const UK_PAST_PARTICIPLE_RULES = [
    {
        id: 'pp-gotten',
...
const UK_COLLECTIVE_NOUN_RULES = [
    {
        id: 'collective-team',
...
export class GrammarTransformer {
    ...
    constructor(variant, options) {
        ...
        if (options?.enabledCategories) {
            this.grammarRules = this.grammarRules.filter(rule => options.enabledCategories.includes(rule.category));
        }
    }
    /**
     ...
     */
    transformOutsideQuotes(text, rule) {
     ...
     */
    static getGrammarRules(variant) {
        if (variant === 'en-US') {
            return [];
        }
        return [
...
//# sourceMappingURL=grammar-transformer.js.map