 ...
 */
import { MIN_OPERATION_COUNT, DELEGATION_KEYWORDS, OPERATION_AGENT_MAPPING } from '../constants.js';
/**
 * Default thresholds
 */
...
export class DelegationDetector {
     ...
     */
    constructor(interactionStore, thresholds) {
     ...
     */
    detectDelegationNeed(operationSequence) {
    ...
    analyzeOperations(operations) {
        ...
        const mapping = OPERATION_AGENT_MAPPING[bestType];
        const confidence = Math.min(mapping.confidence * (maxScore / operations.length), 1.0);
        return {
...
//# sourceMappingURL=delegation-detector.js.map