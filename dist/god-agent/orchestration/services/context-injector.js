...
export class ContextInjector {
     ...
     */
    constructor(interactionStore, maxContextTokens = 8000) {
     ...
     */
    async injectContext(prompt, domain, tags) {
        try {
     ...
     */
    summarizeContext(entries, maxTokens) {
        if (entries.length === 0) {
            return '';
        }
        const contextLines = [
     ...
     */
    mergeContextSections(prompt, newContext) {
