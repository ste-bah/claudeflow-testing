...
export class RecoveryService {
  ...
  private async handleCheck(params: unknown): Promise<RecoveryCheckResult> {
    ...
    return {
      compactionDetected,
      compactionTimestamp: compactionTimestamp ? compactionTimestamp.toISOString() : null,
      inRecoveryMode,
  ...
  private async handleStatus(params: unknown): Promise<RecoveryStatusResult> {
    ...
    return {
      ...
      lastCompactionTimestamp: this.compactionDetector.getCompactionTimestamp()?.toISOString() ?? null,
